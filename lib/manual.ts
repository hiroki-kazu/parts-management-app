...
export const MANUAL_SECTIONS: ManualSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "画面上部の設定から使用者名または会社名を登録すると、全画面のヘッダーに表示されます。",
      "登録名は期間指定ZIPのファイル名・ZIP内CSV名・CSVの作成者情報に自動反映されます。",
    ...
    steps: [
      ...
      "ZIP作成後は、タブレット本体への保存またはメール送信を選択できます。",
      "ZIP名は「登録名_期間指定エクスポート_開始日~終了日.zip」、ZIP内CSV名にも登録名が付きます。",
      "CSVの末尾には作成者名と出力日時が記録されます。",
      "Androidで本体へ保存する場合は保存先フォルダを選択し、保存完了の表示を確認します。",
    ],
  },
  {
    id: "pdf-manual",
